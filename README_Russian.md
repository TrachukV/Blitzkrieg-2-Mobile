...
перемещение, атака, остановка, самоокапывание и удержание позиции уже передаются
в оригинальную симуляцию; для ещё не портированных обработчиков выводятся
оригинальные отключённые иконки.
